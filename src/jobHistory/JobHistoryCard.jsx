  ...
  return (
    <div className='bg-zinc-800 p-4 w-87 rounded-xl flex flex-col gap-3 hover:shadow-[0_0_5px_1px_yellow]'>
      ...
      <div className='flex justify-between'>
       ...
       {props.saved? <IconBookmarkFilled color='yellow' className='text-zinc-400 cursor-pointer' />:<IconBookmark className='text-zinc-400 cursor-pointer' />}
      </div>
      ...
      <div className='flex justify-between'>
        ...
        <div className='flex gap-1 text-xs items-center text-zinc-500'>
         ...
         {props.applied || props.interview?"Applied":props.offered?"Interview":"Posted"} {props.postedDaysAgo} Day ago
        </div>
      </div>
      {
